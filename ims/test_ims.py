...
credentials = (
base64.b64encode(CORRECT_HAAS_USERNAME + ":" + CORRECT_HAAS_PASSWORD), PROJECT,)
...
class TestOperations(unittest.TestCase):
    def test_provision(self):
        good_bmi = BMI(credentials)
        bad_bmi = BMI(credentials)
    ...
    def test_create_snapshot(self):
        ...
        # output = good_bmi.create_snapshot(NOT_EXIST_IMG_NAME, NEW_SNAP_NAME)
        # print output
        # self.assertEqual(output[constants.STATUS_CODE_KEY], 404)
        #
        ...
        output = good_bmi.create_snapshot(EXIST_IMG_NAME, NEW_SNAP_NAME)
        print output
        self.assertEqual(output[constants.STATUS_CODE_KEY], 200)
        ...
        # output = good_bmi.list_snaps(NOT_EXIST_IMG_NAME)
        # print output
        # self.assertEqual(output[constants.STATUS_CODE_KEY], 404)
        #
        # pr = ProjectRepository()
        ...
        output = good_bmi.list_snaps(EXIST_IMG_NAME)
        print output
        self.assertEqual(output[constants.STATUS_CODE_KEY], 200)
        ...
        # output = good_bmi.remove_snaps(NOT_EXIST_IMG_NAME, NEW_SNAP_NAME)
        # print output
        # self.assertEqual(output[constants.STATUS_CODE_KEY], 404)
        #
        # pr = ProjectRepository()
        ...
        output = good_bmi.remove_snaps(EXIST_IMG_NAME, NEW_SNAP_NAME)
        print output
        self.assertEqual(output[constants.STATUS_CODE_KEY], 200)
    ...
    def test_list_all_images(self):
        ...
        # output = good_bmi.list_all_images()
        # print output
        # self.assertEqual(output[constants.STATUS_CODE_KEY], 404)
        #
        # pr = ProjectRepository()
        ...
        print output
        self.assertEqual(output[constants.STATUS_CODE_KEY], 200)
        self.assertEqual(output[constants.RETURN_VALUE_KEY].__len__(), 2)
        self.assertEqual(output[constants.RETURN_VALUE_KEY][0], NOT_EXIST_IMG_NAME)
        self.assertEqual(output[constants.RETURN_VALUE_KEY][1], EXIST_IMG_NAME)
